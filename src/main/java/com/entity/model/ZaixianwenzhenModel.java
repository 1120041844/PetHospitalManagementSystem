...
public class ZaixianwenzhenModel  implements Serializable {
	...
	private String qingkuangmiaoshu;
	...
	public void setQingkuangmiaoshu(String qingkuangmiaoshu) {
		this.qingkuangmiaoshu = qingkuangmiaoshu;
	}
	
	/**
	 * 获取：情况描述
	 */
	public String getQingkuangmiaoshu() {
		return qingkuangmiaoshu;
	}
